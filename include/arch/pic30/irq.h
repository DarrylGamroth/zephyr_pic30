...
/**
 * @file
 * @brief PIC30 public interrupt handling
 *
 * PIC30-specific kernel interrupt handling interface.
 * Included by pic30/arch.h.
 */

#ifndef ZEPHYR_INCLUDE_ARCH_PIC30_IRQ_H_
#define ZEPHYR_INCLUDE_ARCH_PIC30_IRQ_H_
...
/* arch/pic30/core/exc_exit.S */
extern void z_pic30_int_exit(void);
...
static inline void arch_isr_direct_footer(int maybe_switch)
{
#ifdef CONFIG_TRACING
	sys_trace_isr_exit();
#endif
...
extern void z_pic30_irq_direct_dynamic_dispatch_reschedule(void);
extern void z_pic30_irq_direct_dynamic_dispatch_no_reschedule(void);
...
#endif /* ZEPHYR_INCLUDE_ARCH_PIC30_IRQ_H_ */
